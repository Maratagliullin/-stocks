...
class Stock(models.Model):
    ...
    investing_dentifier = models.CharField(
        verbose_name='Идентификатор investing.com', max_length=150,
        blank=True, null=True)
    tradingview_dentifier = models.CharField(
        verbose_name='Идентификатор tradingview.com', max_length=150,
        blank=True, null=True)
...
class SourceDataCompany(models.Model):
    ...
    source_url = models.CharField(
        verbose_name='Ссылка на источник данных', blank=True, null=True,
        max_length=200)
